    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		while($val=mysql_fetch_array($res)) {
		  ...
		  <table width="100%" border="0" cellspacing="10" cellpadding="0">
			...
			echo "</tr>";
			echo "<td class=\"forAnswer\">";
			echo "<input type=\"radio\" name=\"R$i\" value=\"".$val1["repA"]." \">".$val1["repA"]."&nbsp;"; 

echo "<input type=\"radio\" name=\"R$i\" value=\"".$val1["repB"]." \">".$val1["repB"]."&nbsp;"; 

echo "<input type=\"radio\" name=\"R$i\" value=\"".$val1["repC"]." \">".$val1["repC"]."&nbsp;"; 

			if ($val1["repD"]!=null){
echo "<input type=\"radio\" name=\"R$i\" value=\"".$val1["repD"]." \">".$val1["repD"]."</td>";
}
			echo "</tr>";
			...
			<td align="center"><input type="submit" value="Envoyer">
