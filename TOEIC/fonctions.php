...
/*--------------------------------------------------------------------------------------
FONCTION ACTIVATION COMPTE BY MAIL
--------------------------------------------------------------------------------------*/

function activerCompteByMail($mail, $id, $login)
{
     $subject = 'le sujet';
     $message = 'Pour activer votre compte veuillez cliquer sur ce lien ou faire un copier coller dans votre naviguateur'."\n";
	 $message .= 'http://127.0.0.1/toeic/activerCompte.php?id=".$id."$login=".$login."';
