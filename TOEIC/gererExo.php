    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		while($val=mysql_fetch_array($res)) {
		  ...
		  <table width="100%" border="0" cellspacing="10" cellpadding="0">
			<tr><td class="forTexts"><a href="creerExo.php">Créer un nouvel Exercice</a></td></tr>
			<tr><td class="forTexts"><a href="modifierExo.php">Modifier un Exercice</a></td></tr>
			<tr><td class="forTexts"><a href="supprimerExo.php">Supprimer un Exercice</a></td></tr>
		  </table>
                </p>
                </td>
              </tr>
